...
pub use synthesis::{
    ...
    PidState, PolePlacementError, PolePlacementSolve, ProcessFitResult, ProcessPidDesign,
    SampledIoData, SimcPidParams, SopdtModel, StepFitPidDesign, StepOptimizationPidDesign,
    ...
    dplace_poles_dense, fit_fopdt_from_step_response, fit_sopdt_from_step_response, lqg_dense,
    lqr_dense, place_observer_poles_dense, place_poles_dense,
};
